    ...
    if Proceso2 == 1:
        ...
        for i in range(1):
            try:
                ...
                if Nombres in ((d1 and d2) and (c1 and c2 < 70)) or ((d1 and d3) and (c1 and c3 < 70)) or  ((d1 and d4) and (c1 and c4 < 70)) or ((d1 and d5) and (c1 and c5 < 70)) or  ((d2 and d3) and (c2 and c3 < 70)) or ((d2 and d4) and (c2 and c4 < 70)) or ((d2 and d5) and (c2 and c5< 70)) or ((d3 and d4) and (c3 and c4 < 70)) or ((d3 and d5) and (c3 and c5 < 70)) or ((d4 and d5) and (c4 and c5 < 70)):
        ...
        print(concatenacion.describe())
            ...
            print(f"Calificaciones reprobatorias de alumnos con 2 o mas materias: {reprobados}")
